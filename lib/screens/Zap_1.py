...
class Zap_1(Screen):
    ...
    def draw(self, aircraft, smartdisplay):
        ...
        if(self.flyOnSpeedMode == False):
            ...
            # Vertical G
            smartdisplay.draw_text(smartdisplay.RIGHT_MID_UP, self.fontIndicatorSmaller, "G %0.1f" % (aircraft.vert_G), (255, 255, 0))

            # Fuel Flow
            # smartdisplay.draw_text(smartdisplay.RIGHT_MID_DOWN, self.fontIndicatorSmaller, "FF %d %s"  % (aircraft.get_ff(), aircraft.get_speed_description()), (255, 255, 0))
